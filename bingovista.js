...
constructor(params) {
	...
	this.maps.pearls = [
		...
		{ name: "Misc2",            text: "Misc 2",           region: "UNKNOWN", maincolor: "#ff99e6", highlight: "#ffffff", color: "#ff99e6" },
		{ name: "CC",               text: "Gold",             region: "CC",      maincolor: "#e69919", highlight: "#ffff00", color: "#f2cc19" },
		{ name: "SI_west",          text: "Dark Green",       region: "SI",      maincolor: "#020202", highlight: "#199966", color: "#0c412c" },
		{ name: "SI_top",           text: "Dark Blue",        region: "SI",      maincolor: "#020202", highlight: "#196699", color: "#0c2c41" },
		{ name: "LF_west",          text: "Deep Pink",        region: "LF",      maincolor: "#ff004c", highlight: undefined, color: "#ff2667" },
		{ name: "LF_bottom",        text: "Bright Red",       region: "LF",      maincolor: "#ff1919", highlight: undefined, color: "#ff3b3b" },
		{ name: "HI",               text: "Bright Blue",      region: "HI",      maincolor: "#0232ff", highlight: "#80ccff", color: "#215aff" },
		{ name: "SH",               text: "Deep Magenta",     region: "SH",      maincolor: "#330019", highlight: "#ff3399", color: "#841450" },
		{ name: "DS",               text: "Bright Green",     region: "DS",      maincolor: "#00b319", highlight: undefined, color: "#26be3b" },
		{ name: "SB_filtration",    text: "Teal",             region: "SB",      maincolor: "#198080", highlight: undefined, color: "#3b9393" },
		{ name: "SB_ravine",        text: "Dark Magenta",     region: "SB",      maincolor: "#020202", highlight: "#991966", color: "#410c2c" },
		{ name: "GW",               text: "Viridian",         region: "GW",      maincolor: "#00b380", highlight: "#80ff80", color: "#1fc68f" },
		{ name: "SL_bridge",        text: "Bright Purple",    region: "SL",      maincolor: "#6619e6", highlight: "#ff66ff", color: "#9434ed" },
		{ name: "SL_moon",          text: "Pale Yellow",      region: "SL",      maincolor: "#e6f333", highlight: undefined, color: "#e9f451" },
		{ name: "SU",               text: "Light Blue",       region: "SU",      maincolor: "#8099e6", highlight: undefined, color: "#93a8e9" },
		{ name: "UW",               text: "Pale Green",       region: "UW",      maincolor: "#669966", highlight: "#ffb3ff", color: "#7ca37c" },
		{ name: "PebblesPearl",     text: "Active Processes", region: "UNKNOWN", maincolor: "#b3b3b3", highlight: undefined, color: "#bebebe" },
		{ name: "SL_chimney",       text: "Bright Magenta",   region: "SL",      maincolor: "#ff008c", highlight: "#cc4cff", color: "#ff1ab4" },
		...
		{ name: "SU_filt",          text: "Light Pink",       region: "SU",      maincolor: "#ffc0e6", highlight: undefined, color: "#ffc9e9" },
		{ name: "SI_chat3",         text: "Dark Purple",      region: "SI",      maincolor: "#020202", highlight: "#661999", color: "#2c0c41" },
		{ name: "SI_chat4",         text: "Olive Green",      region: "SI",      maincolor: "#020202", highlight: "#669919", color: "#2c410c" },
		{ name: "SI_chat5",         text: "Dark Magenta",     region: "SI",      maincolor: "#020202", highlight: "#991966", color: "#410c2c" },
		{ name: "DM",               text: "Light Yellow",     region: "MS",      maincolor: "#f4eb35", highlight: undefined, color: "#f5ee53" },
		{ name: "LC",               text: "Deep Green",       region: "LC",      maincolor: "#006604", highlight: undefined, color: "#267d29" },
		{ name: "OE",               text: "Light Purple",     region: "OE",      maincolor: "#8c5ecc", highlight: undefined, color: "#9d76d3" },
		{ name: "MS",               text: "Dull Yellow",      region: "GW",      maincolor: "#d0e445", highlight: undefined, color: "#d7e861" },
		{ name: "RM",               text: "Music",            region: "RM",      maincolor: "#622ffb", highlight: "#ff0000", color: "#b02ffb" },
		{ name: "Rivulet_stomach",  text: "Celadon",          region: "UNKNOWN", maincolor: "#96dea0", highlight: undefined, color: "#a5e3ae" },
		...
		{ name: "BroadcastMisc",    text: "Broadcast",        region: "UNKNOWN", maincolor: "#e6b3cc", highlight: "#66e666", color: "#e8c6d1" }
	];
	this.maps.regions = [
